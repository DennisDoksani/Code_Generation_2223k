...
public class JwtTokenProvider {
  ...
  public JwtTokenProvider(BankingUserDetailsService bankingUserDetailsService,
  ...
  public Authentication getAuthentication(String token) {
    ...
    Jws<Claims> claims = Jwts.parserBuilder().setSigningKey(jwtKeyProvider.getPrivateKey()).build()
