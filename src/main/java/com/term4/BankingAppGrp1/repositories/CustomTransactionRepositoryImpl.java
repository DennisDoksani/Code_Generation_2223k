...
public class CustomTransactionRepositoryImpl implements CustomTransactionRepository{
    ...
    @Override
    public Page<Transaction> getTransactionsWithFilters(Pageable pageable, String ibanFrom, String ibanTo, Double amountMin, Double amountMax, LocalDate dateBefore, LocalDate dateAfter) {
        ...
        if (amountMin != null) {
            predicates.add(criteriaBuilder.greaterThanOrEqualTo(transactionRoot.get("amount"), amountMin));
        }
        if (amountMax != null) {
