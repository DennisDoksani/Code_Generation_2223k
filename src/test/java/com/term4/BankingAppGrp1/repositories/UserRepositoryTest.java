...
class UserRepositoryTest extends BaseRepositoryTest {
    ...
    @Test
    void existsByEmailEqualsIgnoreCaseShouldReturnTrueIfContainsInDb() {
        userRepository.save(customerUser);
        boolean exists = userRepository.existsByEmailEqualsIgnoreCase(customerUser.getEmail().toUpperCase());
        assertTrue(exists);
    }

    @Test
    void existsByEmailEqualsIgnoreCaseShouldReturnFalseIfNotContainsInDb() {
        boolean exists = userRepository.existsByEmailEqualsIgnoreCase(customerUser.getEmail().toUpperCase());
        assertFalse(exists);
    }
}
