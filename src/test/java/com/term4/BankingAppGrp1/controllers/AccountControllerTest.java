...
@EnableMethodSecurity(prePostEnabled = true)
 class AccountControllerTest {
    ...
    @Test
    @WithAnonymousUser
    void withoutAuthenticationGetAllEndpointGivesUnauthorized() throws Exception {
    ...
    void withCustomerAuthenticationGetAllEndpointGivesForbidden() throws Exception {
        when(accountService.getAllAccounts(
                1,
                0,
                null
    ...
    void withEmployeeAuthenticationGetAllEndpointGivesOK() throws Exception {
        when(accountService.getAllAccounts(
                1,
                0,
                null
